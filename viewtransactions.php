...
<body>
    <div class="my-bar my-black my-padding my-hide-small">
        ...
        <a href="viewtransactions.php" style="text-decoration:none" class="li my-bar-item my-right my-xlarge my-text-aqua">View Transactions</a>
        <a href="viewcustomers.php" style="text-decoration:none" class="li my-bar-item my-right">View Customers</a>
    </div>
    ...
    <div class="my-bar my-black my-padding my-hide-large" style="display:flex; text-align: center;">
        ...
        <a href="viewcustomers.php" style="text-decoration:none" class="my-bar-item my-small ">View Customers</a>
        <a href="viewtransactions.php" style="text-decoration:none" class="my-bar-item my-small my-text-aqua">View Transactions</a>
    ...
    <div class="my-auto my-margin-top">
        ...
        <p class="my-center my-xxlarge my-hide-large heading2">
            ...
            <table id="datatable" class="my-table-all" style="font-size:12px;">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo '<td style="text-align:center;">' . $row[6] . ' (' . $row[7] . ')</td>';
